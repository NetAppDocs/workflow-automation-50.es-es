...
* *Certificación*
+
Indica si el paquete es creado por el usuario (sin icono, celda vacía), PS (image:../media/ps_certified_icon_wfa.gif[""]), comunidad (image:../media/community_certification.gif[""]), bloqueado por el usuario (image:../media/lock_icon_wfa.gif[""]) O certificado por NetApp (image:../media/netapp_certified.gif[""])
...
* *Versión de entidad*
+
Muestra el número de versión del paquete en formato _major.minor.revision_; por ejemplo, 1.0.0.
