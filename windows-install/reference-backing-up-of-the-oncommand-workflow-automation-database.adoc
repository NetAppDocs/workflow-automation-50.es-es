...
Se crea diariamente una copia de seguridad automática de la base de datos a las 2 a.m. y se guarda como un `.zip` archivo en la siguiente ubicación: `wfa_install_location/WFA-Backups`.
...
NOTE: La base de datos de WFA también se incluye en los datos AutoSupport (ASUP); sin embargo, la contraseña de cualquier usuario de WFA no está incluida en los datos de ASUP.
